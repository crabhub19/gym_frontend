...
export default function About() {
  return (
    <>
    <h1 className="tracking-wide md:text-7xl text-4xl font-oswald font-extrabold dark:dark-text-stroke text-stroke text-center py-12">About Our Community</h1>
      <div className="pb-16">
        <div className="m-auto px-6 md:px-12 lg:px-24">
          <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-24">
            ...
            <div className="md:6/12 lg:w-6/12">
              <h2 className="text-2xl font-bold md:text-4xl font-rock">
