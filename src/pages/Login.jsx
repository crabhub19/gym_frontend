...
<div className="pt-28 min-h-screen flex justify-center items-center">
  <div className=' block w-full'>
    ...
    <div className="flex bg-white dark:bg-dark rounded-lg shadow-2xl overflow-hidden mx-auto max-w-sm lg:max-w-4xl drop-shadow-2xl">
        <div className="hidden lg:block lg:w-1/2 bg-cover bg-login-page-bg dark:bg-login-page-form">
        </div>
 ...
 We want to authenticate you
            ...
            <div className="">
                <button type='submit' className="bg-main hover:bg-main-dark text-white font-bold py-2 px-4 w-full rounded">Login</button>
            </div>
            <div className="mt-4 flex items-center justify-between group">
                ...
                <a href="#" className="text-xs hover:text-theme uppercase">or forgot password</a>
                <span className="border-b w-1/5 md:w-1/4 group-hover:border-theme"></span>
            </div>
            <div className="mt-4 flex items-center justify-between group">
                <span className="border-b w-1/5 md:w-1/4 group-hover:border-theme"></span>
                <a href="#" className="text-xs hover:text-theme uppercase">or sign up</a>
                <span className="border-b w-1/5 md:w-1/4 group-hover:border-theme"></span>
            </div>
        </div>
    </div>
