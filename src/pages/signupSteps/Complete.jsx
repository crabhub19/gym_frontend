  ...
  return (
    <>
      <div className='shadow-2xl drop-shadow-2xl rounded-sm dark:border-white md:max-w-[460px] dark:bg-dark'>
        ...
        <div className=''>
          <div className='flex font-lato text-md items-center w-full flex-wrap'>
            <div className='min-w-28'>Transaction ID</div>
            <hr className='min-w-16 mx-2' />
            <div>{formData.transaction_id}</div>
          </div>
        </div>
        <div className=''>
          <div className='flex font-lato text-md items-center w-full flex-wrap'>
            <div className='min-w-28'>Number</div>
            <hr className='min-w-16 mx-2' />
      ...
      <div>
        <blockquote className='text-center font-oswald'>We will send you a email for verification. And you have to wait for verification your ID then you can login.</blockquote>
      </div>
      </div>
      </div>
    </>
