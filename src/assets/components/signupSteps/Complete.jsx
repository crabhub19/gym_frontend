...
export default function Complete() {
  return (
    <>
      <div className='shadow-2xl drop-shadow-2xl dark:border rounded-sm dark:border-white md:max-w-[460px]'>
        ...
        <div>
          <div className='flex font-lato text-md items-center w-full flex-wrap'>
            ...
            <div>3xxxxxxxxxxxxxxbishal@gamil.com</div>
          </div>
        </div>
        <div className=''>
          <div className='flex font-lato text-md items-center w-full flex-wrap'>
